...
function locationObject() {
 ...
 //gpoint, icon and other stuff created
 //many lines of code omitted
 //...

 //Marker
 this.gmarker = new GMarker(this.gpoint, this.markerOptions);

 //IW onclick listener
 GEvent.addListener(this.gmarker, "click", function() {
   //Error on the line below!
   this.gmarker.openExtInfoWindow(mapRef, "mymap_iw", htmlContentRef,
{beakOffset: 3});
 });
