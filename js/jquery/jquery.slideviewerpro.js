...
jQuery(function(){
   jQuery("div.svwp").prepend("<img src='skin/frontend/base/hgp/images/svwloader.gif' class='ldrgif' width='220' height='19' alt='loading...'/ >"); //change with YOUR loader image path   
});
var j = 0;
